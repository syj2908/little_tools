...
#焦点切换回默认frame
driver.switch_to.default_content()
iframe = driver.find_element_by_xpath("//*[@id='mini-17$body$6']/iframe")
iframelist.append(iframe)
...
#填写今日体温
temperature = 36 + random.randint(5, 7)
#随机生成36.5~36.7之间的体温
driver.find_element_by_xpath("//*[@id='BRTW$text']").send_keys(temperature)

#提交按钮在第三层iframe上，我们现在在第四层iframe，因此回到这一层的父层
